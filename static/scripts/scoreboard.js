...
function drawScorebox3(svgarea, scoreboxdata, tile_size) {
	...
	.attr("xlink:href",  function(d) { d.team=1; return "static/images/" + d.team1.id.toLowerCase() +".png"})
	.attr("team", 2)
	...
	scorebox.append("image")
	.attr("xlink:href",  function(d) { d.team=2; return "static/images/" + d.team2.id.toLowerCase() +".png"})
	.attr("team", 2)
